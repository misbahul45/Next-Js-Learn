...
const AddForm = () => {
  ...
  return (
    <div onClick={toggleForm} className='size-56 flex justify-center items-center border-dashed border-2 border-slate-700 rounded-lg cursor-pointer hover:border-solid hover:bborder-slate-900 transition-all duration-100 group'>
